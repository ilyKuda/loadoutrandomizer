...
function setRngMode(value) {
    ...
    (function setupLoadoutScreenPage(){
      ...
      const randomizerTitleSrc = "/assets/embedded/img_0004_dd1122bc9e0b.svg";
      window.__kudaRandomizerTitleSrc = randomizerTitleSrc;
      if (titleImage) titleImage.src = randomizerTitleSrc;
      const homeTitleSrc = "/assets/embedded/img_0017_24821be00405.svg";
      window.__kudaHomeTitleSrc = homeTitleSrc;
      const screenTitleSrc = "/assets/embedded/img_0018_b54f77a90382.svg";
      window.__kudaScreenTitleSrc = screenTitleSrc;
      const thumbnailTitleSrc = "/assets/embedded/img_0019_a15d73f870b8.svg";
      window.__kudaThumbnailTitleSrc = thumbnailTitleSrc;
      const tierTitleSrc = "/assets/embedded/img_0020_7da9785e0e22.svg";
      window.__kudaTierTitleSrc = tierTitleSrc;
      const challengeTitleSrc = "/assets/embedded/img_0021_f00d9de86b4c.svg";
      ...
      const screenBackgrounds = {
        ...
        waterpark: "/assets/embedded/img_0022_730eb59387bd.webp",
        dockyard: "/assets/embedded/img_0023_cea075477c0a.webp"
      };
      ...
      const routeToPage = page => {
        const routes = {
          home: "/",
          randomizer: "/loadout-randomizer/",
          screen: "/loadout-screen/",
          thumbnail: "/thumbnail-builder/",
          tier: "/tier-list-builder/",
          challenge: "/challenge-road/"
        };
...
thumbClearBtn?.addEventListener("click", () => {
      ...
      function setupChallengeRoadBuilder(){
        ...
        const defaultBgSrc = "/assets/embedded/img_0010_ecf8cbff283c.jpg";
        const transparentRoadSrc = "/assets/embedded/img_0024_8fd104844ae4.png";
        let customBgSrc = "";
        let bgMode = "default";
        let challenges = [];
        let selectedId = null;
