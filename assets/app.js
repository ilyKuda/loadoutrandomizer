...
const __RT_BASE__ = (() => {
  ...
  return '';
    ...
    const embeddedImages = {"Distortion":"Weapons/Distortion_Icon.webp","Permafrost":"Weapons/Permafrost_Icon.webp","Energy Rifle":"Weapons/Energy_Rifle_29.webp","Flamethrower":"Weapons/Flamethrower_Icon.webp","Grenade Launcher":"Weapons/GrenadeLauncher_Icon.webp","Minigun":"Weapons/Minigun_Icon.webp","Paintball Gun":"Weapons/PaintballGun_Icon.webp","Assault Rifle":"Weapons/AssaultRifle_Icon.webp","Bow":"Weapons/Bow_Icon.webp","Burst Rifle":"Weapons/BurstRifle_Icon.webp","Crossbow":"Weapons/Crossbow_Icon.webp","Gunblade":"Weapons/Gunblade_Icon.webp","RPG":"Weapons/RPG_Icon.webp","Shotgun":"Weapons/Shotgun_Icon.webp","Sniper":"Weapons/Sniper_Icon.webp","Scepter":"Weapons/Scepter_Icon.webp","Warper":"Weapons/Warper_Icon.webp","Energy Pistols":"Weapons/EnergyPistols_Icon.webp","Exogun":"Weapons/Exogun_Icon.webp","Slingshot":"Weapons/Slingshot_Icon.webp","Daggers":"Weapons/Daggers_Icon.webp","Flare Gun":"Weapons/FlareGun_Icon.webp","Handgun":"Weapons/Handgun_Icon.webp","Revolver":"Weapons/Revolver_Icon.webp","Shorty":"Weapons/Shorty_Icon.webp","Spray":"Weapons/Spray_Icon.webp","Uzi":"Weapons/Uzi_Icon.webp","Glass Cannon":__RT_BASE__ + "/assets/embedded/img_0013_f2d06b26fcc2.webp","Maul":"Weapons/Maul_Icon.webp","Spear":"Weapons/Spear_Icon.webp","Trowel":"Weapons/Trowel_Icon.webp","Battle Axe":"Weapons/BattleAxe_Icon.webp","Chainsaw":"Weapons/Chainsaw_Icon.webp","Fists":"Weapons/Fists_Icon.webp","Katana":"Weapons/Katana_Icon.webp","Knife":"Weapons/Knife_Icon.webp","Riot Shield":"Weapons/RiotShield_Icon.webp","Scythe":"Weapons/Scythe_Icon.webp","Glass Shard":__RT_BASE__ + "/assets/embedded/img_0014_d69d6b9004b6.webp","Grappler":"Weapons/Grappler_Icon.webp","Medkit":"Weapons/Medkit_Icon.webp","Subspace Tripmine":"Weapons/SubspaceTripmine_Icon.webp","Warpstone":"Weapons/Warpstone_Icon.webp","Flashbang":"Weapons/Flashbang_Icon.webp","Freeze Ray":"Weapons/FreezeRay_Icon.webp","Grenade":"Weapons/Grenade_Icon.webp","Jump Pad":"Weapons/JumpPad_Icon.webp","Molotov":"Weapons/Molotov_Icon.webp","Satchel":"Weapons/Satchel_Icon.webp","Smoke Grenade":"Weapons/SmokeGrenade_Icon.webp","War Horn":"Weapons/WarHorn_Icon.webp","Elixir":__RT_BASE__ + "/assets/embedded/img_0015_36ee11bc7997.webp","RNG Dice":__RT_BASE__ + "/assets/embedded/img_0016_43eec6a9ad4f.webp"};
...
function setRngMode(value) {
    ...
    (function setupLoadoutScreenPage(){
      ...
      const randomizerTitleSrc = __RT_BASE__ + "/assets/embedded/img_0004_dd1122bc9e0b.svg";
      window.__kudaRandomizerTitleSrc = randomizerTitleSrc;
      if (titleImage) titleImage.src = randomizerTitleSrc;
      const homeTitleSrc = __RT_BASE__ + "/assets/embedded/img_0017_24821be00405.svg";
      window.__kudaHomeTitleSrc = homeTitleSrc;
      const screenTitleSrc = __RT_BASE__ + "/assets/embedded/img_0018_b54f77a90382.svg";
      window.__kudaScreenTitleSrc = screenTitleSrc;
      const thumbnailTitleSrc = __RT_BASE__ + "/assets/embedded/img_0019_a15d73f870b8.svg";
      window.__kudaThumbnailTitleSrc = thumbnailTitleSrc;
      const tierTitleSrc = __RT_BASE__ + "/assets/embedded/img_0020_7da9785e0e22.svg";
      window.__kudaTierTitleSrc = tierTitleSrc;
      const challengeTitleSrc = __RT_BASE__ + "/assets/embedded/img_0021_f00d9de86b4c.svg";
      ...
      const screenBackgrounds = {
        ...
        waterpark: __RT_BASE__ + "/assets/embedded/img_0022_730eb59387bd.webp",
        dockyard: __RT_BASE__ + "/assets/embedded/img_0023_cea075477c0a.webp"
      };
      ...
      const skinAssetFolders = ["Skins", "Skins2", "Skins3", "Skins4", "Skins5"];
      const mapAssetFolders = ["maps", "Maps"];
      const assetFileUrl = (folder, file) => `${folder}/${String(file).split("/").map(part => encodeURIComponent(part)).join("/")}`;
      ...
      function setSkinFileImage(img, file, fallbackSrc = "") {
        ...
        img.onerror = () => {
          attempt += 1;
          if (attempt < skinAssetFolders.length) {
            img.src = skinFileUrl(file, attempt);
          } else {
            img.onerror = null;
            if (fallbackSrc) img.src = fallbackSrc;
          }
        };
        img.src = skinFileUrl(file, 0);
      }
      ...
      function setMapFileImage(img, files, fallbackSrc = "") {
        ...
        const attempts = [];
        mapAssetFolders.forEach((folder, folderIndex) => {
          candidates.forEach(file => attempts.push(mapFileUrl(file, folderIndex)));
        });
        let attempt = 0;
        img.onerror = () => {
          attempt += 1;
...
thumbClearBtn?.addEventListener("click", () => {
      ...
      function setupTierListBuilder(){
        ...
        const mapFilenameOverrides = {
          "Chess": ["chess_map.png"],
          "Battleground": ["Battelgroundsicon.png"],
          "Village": ["Villagethumbnail.png"],
          "Legacy Battleground": ["Legacybattlegroundsicon.png"],
          "Legacy Big Splash": ["Legacybigdocksicon.png"],
          "Big Station": ["BigStation.png"]
        };
        ...
        const mapFilenameCandidates = name => {
          ...
          const bases = [clean, compact, underscored, dashed, `${clean}icon`, `${compact}icon`, `${clean}Icon`, `${compact}Icon`, lower, lowerCompact, lowerUnderscore, `${lowerCompact}icon`];
      ...
      function setupChallengeRoadBuilder(){
        ...
        const defaultBgSrc = __RT_BASE__ + "/assets/embedded/img_0010_ecf8cbff283c.jpg";
        const transparentRoadSrc = __RT_BASE__ + "/assets/embedded/img_0024_8fd104844ae4.png";
        let customBgSrc = "";
        let bgMode = "default";
        let challenges = [];
        let selectedId = null;
